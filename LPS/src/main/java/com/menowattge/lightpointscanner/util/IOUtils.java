...
public class IOUtils {
    ...
    public static Location getLocationFromIntent(Intent intent) {
        ...
        if (isShowRadarIntent(intent)) {
            ...
            if (LocationUtils.isValidLatitude(latFloat) && LocationUtils.isValidLongitude(lonFloat)) {
                ...
                if (LocationUtils.isValidLatitude(latDouble) && LocationUtils.isValidLongitude(lonDouble)) {
                    lat = latDouble;
                    lon = lonDouble;
                }
            }

            if (LocationUtils.isValidLatitude(lat) && LocationUtils.isValidLongitude(lon)) {
    ...
    public static Location getLocationFromGeoUri(String geoUri) {
        ...
        if (LocationUtils.isValidLatitude(Double.valueOf(coords[0])) && LocationUtils.isValidLongitude(Double.valueOf(coords[1]))) {
