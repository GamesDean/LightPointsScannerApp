 ...
 */
package com.menowattge.lightpointscanner.util;
...
import com.menowattge.lightpointscanner.BuildConfig;
...
import com.menowattge.lightpointscanner.view.GpsSkyView;
...
public class UIUtils {
    ...
    public static int snrToIndicatorLeftMarginPx(float snr, int minIndicatorMarginPx, int maxIndicatorMarginPx) {
        return (int) MathUtils.mapToRange(snr, GpsSkyView.MIN_VALUE_SNR, GpsSkyView.MAX_VALUE_SNR, minIndicatorMarginPx, maxIndicatorMarginPx);
    }
    ...
    public static int snrToTextViewLeftMarginPx(float snr, int minTextViewMarginPx, int maxTextViewMarginPx) {
        return (int) MathUtils.mapToRange(snr, GpsSkyView.MIN_VALUE_SNR, GpsSkyView.MAX_VALUE_SNR, minTextViewMarginPx, maxTextViewMarginPx);
    }
    ...
    public static int cn0ToIndicatorLeftMarginPx(float cn0, int minIndicatorMarginPx, int maxIndicatorMarginPx) {
        return (int) MathUtils.mapToRange(cn0, GpsSkyView.MIN_VALUE_CN0, GpsSkyView.MAX_VALUE_CN0, minIndicatorMarginPx, maxIndicatorMarginPx);
    }
    ...
    public static int cn0ToTextViewLeftMarginPx(float cn0, int minTextViewMarginPx, int maxTextViewMarginPx) {
        return (int) MathUtils.mapToRange(cn0, GpsSkyView.MIN_VALUE_CN0, GpsSkyView.MAX_VALUE_CN0, minTextViewMarginPx, maxTextViewMarginPx);
    }
