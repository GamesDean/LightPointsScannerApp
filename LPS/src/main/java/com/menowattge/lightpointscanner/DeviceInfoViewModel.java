...
import com.menowattge.lightpointscanner.model.ConstellationFamily;
import com.menowattge.lightpointscanner.model.Satellite;
...
public class DeviceInfoViewModel extends AndroidViewModel {
    ...
    private ConstellationFamily getSatellitesFromStatuses(List<SatelliteStatus> allStatuses) {
        ...
        for (SatelliteStatus s : allStatuses) {
            ...
            if (s.getCn0DbHz() != SatelliteStatus.NO_DATA) {
                numSignalsInView++;
            }
            ...
            if (!carrierLabel.equals(CarrierFreqUtils.CF_UNKNOWN) && !carrierLabel.equals(CarrierFreqUtils.CF_UNSUPPORTED)
            ...
            if (!satellites.containsKey(key)) {
                ...
                if (!satStatuses.containsKey(carrierLabel)) {
                    ...
                    for (SatelliteStatus satelliteStatus : satStatuses.values()) {
                        ...
                        if (satelliteStatus.getCn0DbHz() != SatelliteStatus.NO_DATA) {
                            frequenciesInView++;
                        }
                    }
                    ...
                    if (frequenciesInView == 1 && s.getCn0DbHz() != SatelliteStatus.NO_DATA) {
